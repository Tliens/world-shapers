...
window.AppI18N = (function () {
  ...
  var DICT = {
    zh: {
      ...
      sort_label: '排序', sort_year: '时代先后', sort_cat: '按领域', sort_votes: '按票数',
      sorted_votes: ' · 按票数排序',
      vote_aria: '到 GitHub 投票', vote_btn: '👍 投票',
      vote_tooltip: '点击前往 GitHub 点 👍 投一票（需登录）',
      hl_title: '✦ 主要成就',
      ...
      about3_p: '点击任意卡片查看详细生平与名言，支持方向键切换；按领域筛选、关键词搜索，或按票数排序；点击卡片左上角的 ▲ 或详情页的投票按钮，可前往 GitHub 为 TA 投上一票；右上角可切换深浅色模式与语言。背景星空由 Three.js 实时渲染。',
    ...
    en: {
      ...
      sort_label: 'Sort', sort_year: 'By era', sort_cat: 'By field', sort_votes: 'By votes',
      sorted_votes: ' · sorted by votes',
      vote_aria: 'Vote on GitHub', vote_btn: '👍 Vote',
      vote_tooltip: 'Open GitHub and add a 👍 reaction to vote (sign-in required)',
      hl_title: '✦ Key achievements',
      ...
      about3_p: 'Click any card for a detailed biography and quotes; arrow keys page through people. Filter by field, search by keyword, sort by era or by votes — the ▲ badge on each card (or the Vote button in a profile) opens GitHub where a 👍 counts as a vote. Use the buttons at the top right to switch theme and language. The starry background is rendered live with Three.js.',
